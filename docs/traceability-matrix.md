...
| 根拠 | 実装 / docs | 検証 |
| --- | --- | --- |
| NON PICKUP Rank 40 | `README.md`, `docs/requirements.md` | `docs/source-idea-pack.json` |
| 必須項目 `title`, `limitWindow`, `nextAction` | `src/core/productProfile.js` | `samples/representative-suite.json` |
