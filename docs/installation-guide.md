...
2. `dist/bedtime-routine-phone-limiter-docs.zip`、`docs/manual-test.md`、`docs/strict-manual-test-addendum.md` を取得する。
3. repo を clone する。

```powershell
git clone https://github.com/Sunmax0731/bedtime-routine-phone-limiter.git
cd bedtime-routine-phone-limiter
