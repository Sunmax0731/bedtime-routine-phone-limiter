# 手動テスト
        ...
        `D:\AI\AndroidApp\bedtime-routine-phone-limiter`

        ## 事前準備

        1. GitHub Release `v0.1.0-alpha.1` から `dist/bedtime-routine-phone-limiter-docs.zip` を取得できることを確認する。
